...
def render_code_screenshot(
    ...
    code_top = title_h + tab_h + breadcrumb_h + minimal_header_h + pad_top
    code_text_height = num_lines * line_height
    code_bottom = code_top + code_text_height + pad_bottom
    total_height = int(code_bottom + status_h)
    ...
    if use_chrome:
        _draw_status_bar(svg, theme, W, code_bottom, status_h, lexer, start_line,
